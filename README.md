...
## Overall Reflection of Day 1 to Day 8 of induction program 
* The first eight days of my journey at the college have been full of learning, exploration, and new experiences. From the very first day, I was introduced to the environment of the campus, met new classmates, and got guidance from our respected teachers and seniors. Every day brought something unique — whether it was expert lectures, interactive sessions, or hands-on activities.
* We attended lectures on different subjects like physics, mathematics, food and wellness, universal human values, and even the importance of millets in our diet. These sessions not only increased my knowledge but also made me understand how these topics connect to our everyday lives. I especially enjoyed the experiments and practical demonstrations, as they made learning more interesting.
* Our seniors also guided us about useful platforms like GitHub, helping us create accounts and our first repository. Alongside academics, we had sessions that encouraged us to think about relationships, happiness, and how to maintain balance in life. The campus exploration was another memorable part — visiting the Gurudwara Sahib, dispensary, post office, sports grounds, and many more places made me feel more connected to the college.
* Overall, these eight days have been a beautiful beginning to my college life. I have learned a lot, gained confidence, and made new friends. As a first-year fresher student, I feel motivated and excited to continue this journey with the same energy and curiosity.

## Day 9 of Induction Program
* The ninth day of our induction program started with an engaging session conducted by the Mathematics Club members. They warmly introduced their club and explained the various activities they usually conduct to enhance logical and analytical skills among students. Along with this, they informed us about the upcoming Teacher’s Day competitions, which included Digital Poster Making, Vase Painting, and a Mathematics Quiz. All these competitions seemed exciting and creative, as they not only test our knowledge but also encourage us to showcase our talent in art and innovation.
* After the Mathematics Club, the turn was of the English Club members. They gave us an introduction to their club and shared how their activities help students improve language skills, communication, and confidence. To make the session interactive, they organized a small game in which their members asked us the meanings of different English words. It was a fun way of learning, as everyone actively participated. The students who gave correct answers were rewarded with chocolates. I was also very happy to get one chocolate as I managed to answer one of the questions correctly. This small activity created a lively and cheerful atmosphere in the hall.
* The last session of the day was a lecture on Artificial Intelligence (AI), delivered by a member of the Ikigai School of AI. The lecture was very informative and eye-opening. We were told about how AI is shaping the future of technology and becoming a part of our daily lives. AI is used in various fields such as healthcare (diagnosing diseases), education (personalized learning), business (data analysis), transport (self-driving cars), and entertainment (recommendation systems on apps like YouTube and Netflix). The speaker also explained how AI makes machines capable of learning from data, solving problems, and even making decisions like humans.
* Another important point highlighted was the responsible use of AI. While AI has the potential to bring revolutionary changes in the world, it must be developed and applied ethically, keeping in mind privacy, security, and human values. The session left us inspired to learn more about AI and how it can be used to create a better tomorrow.
## Reflection 
Overall, Day 9 was a combination of learning, creativity, fun, and inspiration. From knowing about the clubs and their activities to understanding one of the most powerful technologies of our time, it turned out to be a very productive and memorable day.
